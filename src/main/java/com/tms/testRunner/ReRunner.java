...
@CucumberOptions(
		...
		features = {"@rerun/failed_scenarios.txt"},  //Cucumber execute failed scenarios from this file
		glue = { "com/tms/stepdefinitions" }, 
		plugin = {"pretty",
		 "html:target/cucumber-reports/cucumber.html", "json:target/cucumber-reports/CucumberTestReport.json" },
